...
const FeedItem = ({
    ...
    return (
        <div className="w-full mb-3 md:mb-4 mx-auto">
            ...
            >
                {distanceLabel && (
                    <div className="absolute top-5 left-5 md:left-auto md:right-3 z-10 inline-flex items-center gap-1.5 rounded-full bg-white/90 px-3 py-1.5 shadow-sm backdrop-blur-sm">
